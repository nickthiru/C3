...
class ProvisionSingleDeviceStack extends Stack {
  constructor(scope, id, props) {
    ...
    this.provisionSingleDeviceRequestedTopicArn = provisionSingleDeviceRequested_Topic.topicArn;
...
module.exports = { ProvisionSingleDeviceStack };